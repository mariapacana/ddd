...
SEED_LEVELS = [{count: 1, mode: "solo", lastRound: 2, played: false}, {count: 2, mode: "coop", lastRound: 11, played: false}, {count: 3, mode: "versus", lastRound: 15, played: false}, {count: 4, mode: "versus-group", lastRound: 17, played: false}];
...
SEED_ROUNDS = [{roundCount: 1, current: true, mode: "solo", state: STARTING},
               ...
               {roundCount: 16, current: false, mode: "versus-group", state: VOTING},
               {roundCount: 17, current: false, mode: "versus-group", state: VOTING}];
