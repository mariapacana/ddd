...
SEED_ROUNDS = [{roundCount: 1, current: true, level: 1, mode: "solo", state: STARTING},
               ...
               {roundCount: 8, current: false, level: 1, mode: "coop", state: VOTING},
               {roundCount: 9, current: false, level: 1, mode: "coop", state: VOTING},
...
// SEED_LEVELS = [{count: 1, mode: "solo", lastRound: 1, played: false},
//                {count: 2, mode: "coop", lastRound: 2, played: false},
//                {count: 3, mode: "versus", lastRound: 3, played: false},
//                {count: 4, mode: "versus-group", lastRound: 4, played: false},
//                {count: 5, mode: "finale", lastRound: 5, played: false}];

// SEED_ROUNDS = [{roundCount: 1, current: true, level: 1, mode: "solo", state: STARTING},
//                {roundCount: 2, current: false, level: 2, mode: "coop", state: VOTING},
//                {roundCount: 3, current: false, level: 3, mode: "versus", state: VOTING},
//                {roundCount: 4, current: false, level: 4, mode: "versus-group", state: VOTING},
//                {roundCount: 5, current: false, level: 5, mode: "finale", state: VOTING}];
...
//                {round: 4, text: "ukulele"},
//                {round: 4, text: "singing Happy Birthday"},
//                {round: 5, text: "demoted"},
//                {round: 5, text: "fired"},
//                {round: 5, text: "promoted"}];