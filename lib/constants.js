...
SEED_OPTIONS = [{round: 1, text: "apology", mode: "solo"},
               ...
               {round: 14, text: "side planking", mode: "versus"},
               {round: 14, text: "balloon animals", mode: "versus"},
               {round: 14, text: "finding a lost object", mode: "versus"},
               {round: 15, text: "sculpture", mode: "versus"},
               {round: 15, text: "project runway", mode: "versus"},
               {round: 15, text: "memory palaces", mode: "versus"},
               {round: 16, text: "dance routine redux", mode: "group"},
               {round: 16, text: "telephone", mode: "group"},
               {round: 16, text: "the wave", mode: "group"},
               {round: 17, text: "harmonizing", mode: "group"},
               {round: 17, text: "vertical dodgeball", mode: "group"},
               {round: 17, text: "contacting the president", mode: "group"}];